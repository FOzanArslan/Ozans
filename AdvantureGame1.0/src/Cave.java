...
public class Cave extends BattleLoc{
    ...
    void combat() {
        ...
        Obstacle myObstacle = new Vampire();
        ...
        System.out.println("The sum of vampire health : " + myObstacle.obsHealth);
        System.out.println("The sum of vampire damage per round : " + myObstacle.obsDamage);
        System.out.println();
        ...
        if (userFChoice == 1) {
            while (true) {
                ...
                if (Player.health <= 0) {
                    ...
                    System.out.println();
                    System.out.println("You passed the cave section.");
                    Player.money += myObstacle.obsMoney * obsCount;
                    Player.passCave = true;
                    onLocation();
    ...
    @Override
    void BattleLoc(Obstacle vampire) {
        vampire.obstacleNumber();
    }
}
