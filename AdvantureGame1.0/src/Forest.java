...
public class Forest extends BattleLoc {
    ...
    void combat() {
        ...
        Obstacle myObstacle = new Zombie();
        ...
        System.out.println("The sum of zoombies health : " + myObstacle.obsHealth);
        System.out.println("The sum of zombies damage per round : " + myObstacle.obsDamage);
        System.out.println();
        ...
        if (userFChoice == 1) {
            while (true) {
                ...
                if (Player.health <= 0) {
                    ...
                    System.out.println();
                    System.out.println("You passed the forest section.");
                    Player.money += myObstacle.obsMoney * obsCount;
                    Player.passForest = true;
                    onLocation();
